...
module.exports = function(config) {
    return {
        ...
        reactivateFacebook: function(next) {
            if (config.facebook) {
                request.post("https://graph.facebook.com/v2.6/me/subscribed_apps?access_token=" + process.env.FACEBOOK_PAGE_TOKEN,
                    function(err, res, body) {
                        ...
                        if (err) {
                            ...
                            if (isSuccess) {
                                ...
                                return next("Was unable to successfully ping Facebook endpoint with following token: " + process.env.FACEBOOK_PAGE_TOKEN);
                            }
